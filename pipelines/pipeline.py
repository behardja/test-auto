...
def create_training_pipeline(pipeline_job_spec_path: str):
    ...
    hello_world = load_custom_component(component_name='hello_world')
    ...
    def pipeline(
        ...
        registry_placeholder = hello_world().after(train_model_task).set_display_name("register-model-artifact")
