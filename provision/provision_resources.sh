...
PIPELINE_JOB_SUBMISSION_SERVICE_IMAGE="us-central1-docker.pkg.dev/sandbox-401718/dry-beans-dt-artifact-registry/dry-beans-dt/submission_service:latest"
...
PIPELINE_JOB_RUNNER_SERVICE_ACCOUNT_LONG="vertex-pipelines@sandbox-401718.iam.gserviceaccount.com"
...
SOURCE_REPO_NAME="behardja/test-auto"
SOURCE_REPO_BRANCH="automlops"
STORAGE_BUCKET_NAME="sandbox-401718-dry-beans-dt-bucket"
